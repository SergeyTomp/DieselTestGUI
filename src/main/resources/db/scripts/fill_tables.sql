...
INSERT INTO MANUFACTURER_HEUI (MANUFACTURER_NAME, IS_CUSTOM)
  SELECT * FROM CSVREAD('classpath:/db/csv/manufacturersHeui.csv');

INSERT INTO MANUFACTURER_HEUI (MANUFACTURER_NAME, IS_CUSTOM)
  SELECT * FROM CSVREAD('~/stardex/custom_csvs/manufacturersHeui_custom.csv');
