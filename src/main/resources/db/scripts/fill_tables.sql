...
INSERT INTO PUMP (PUMP_CODE, MANUFACTURER_NAME, CUSTOM, FEED_PRESSURE, ROTATION, REGULATOR_CONFIG, PRESSURE_CONTROL, REGULATOR_TYPE, SCV_CURRENT_INJ, SCV_MIN_CURRENT, SCV_MAX_CURRENT)
