...
public class SpinnerDefaults {

    public static final int WIDTH_CURRENT_SIGNAL_SPINNER_MIN = 120;
    ...
    public static final int FIRST_W_SPINNER_INIT = 500;
    public static final int FIRST_W_SPINNER_STEP = 10;

    public static final double BOOST_I_SPINNER_MIN = 3;
    ...
    public static final double FIRST_I_SPINNER_INIT = 15;
    public static final double FIRST_I_SPINNER_STEP = 0.1;
    public static final double FIRST_I_SPINNER_FAKE = 15.01;

    public static final double SECOND_I_SPINNER_MIN = 1;
    public static final double SECOND_I_SPINNER_MAX = 25.5;
    public static final double SECOND_I_SPINNER_INIT = 5.4;
    public static final double SECOND_I_SPINNER_STEP = 0.1;
    public static final double SECOND_I_SPINNER_FAKE = 5.51;

    public static final int BATTERY_U_SPINNER_MIN = 11;
    public static final int BATTERY_U_SPINNER_MAX = 32;
    public static final int BATTERY_U_SPINNER_INIT = 20;
    public static final int BATTERY_U_SPINNER_STEP = 1;

    public static final int NEGATIVE_U_SPINNER_MIN = 17;
    public static final int NEGATIVE_U_SPINNER_MAX = 121;
    public static final int NEGATIVE_U_SPINNER_INIT = 48;
    public static final int NEGATIVE_U_SPINNER_STEP = 1;

    public static final int BOOST_U_SPINNER_MIN = 30;
