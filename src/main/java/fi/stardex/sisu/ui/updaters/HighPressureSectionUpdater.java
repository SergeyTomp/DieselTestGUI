...
//                highPressureSectionController.getPressReg1().getValueFactory().setValue(pressure.intValue());
//            }
        ...
        if(PressureReg1_DutyFact.getLastValue() != null && reg1paramActive != DUTY){
            highPressureSectionController.getDutyCycleReg1().getValueFactory().setValue(dataConverter.round((double)PressureReg1_DutyFact.getLastValue()));
        }
        if(PressureReg1_I_Fact.getLastValue() != null && reg1paramActive != CURRENT){
            highPressureSectionController.getCurrentReg1().getValueFactory().setValue(dataConverter.round((double)PressureReg1_I_Fact.getLastValue()));
        }
        if(PressureReg2_I_Fact.getLastValue() != null && reg2paramActive != CURRENT){
            highPressureSectionController.getCurrentReg2().getValueFactory().setValue(dataConverter.round((double)PressureReg2_I_Fact.getLastValue()));
        }
        if(PressureReg2_DutyFact.getLastValue() != null &&  reg2paramActive != DUTY){
            highPressureSectionController.getDutyCycleReg2().getValueFactory().setValue(dataConverter.round((double)PressureReg2_DutyFact.getLastValue()));
        }
        if(PressureReg3_I_Fact.getLastValue() != null && reg3paramActive != CURRENT){
            highPressureSectionController.getCurrentReg3().getValueFactory().setValue(dataConverter.round((double)PressureReg3_I_Fact.getLastValue()));
        }
        if(PressureReg3_DutyFact.getLastValue() != null && reg3paramActive != DUTY){
            highPressureSectionController.getDutyCycleReg3().getValueFactory().setValue(dataConverter.round((double)PressureReg3_DutyFact.getLastValue()));
        }
    }
}
