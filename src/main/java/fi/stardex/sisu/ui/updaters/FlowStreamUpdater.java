...
public class FlowStreamUpdater extends FlowUpdater implements Updater{
    ...
    public void run() {
        ...
        if ((value = ModbusMapFlow.Channel5Level.getLastValue().toString()) != null)
            show(value, deliveryFlowComboBox.getSelectionModel().getSelectedItem(), Flow.BACK_FLOW_1);

        if ((value = ModbusMapFlow.Channel6Level.getLastValue().toString()) != null)
            show(value, deliveryFlowComboBox.getSelectionModel().getSelectedItem(), Flow.BACK_FLOW_2);

        if ((value = ModbusMapFlow.Channel7Level.getLastValue().toString()) != null)
            show(value, deliveryFlowComboBox.getSelectionModel().getSelectedItem(), Flow.BACK_FLOW_3);

        if ((value = ModbusMapFlow.Channel8Level.getLastValue().toString()) != null)
            show(value, deliveryFlowComboBox.getSelectionModel().getSelectedItem(), Flow.BACK_FLOW_4);
        ...
        if ((value = ModbusMapFlow.Channel1Temperature1.getLastValue().toString()) != null) {
            ...
            temperature1Delivery1Label.setText(ledBeaker1ToggleButton.isSelected() ? value : null);
        ...
        if ((value = ModbusMapFlow.Channel1Temperature2.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature2Delivery1Label.setText(ledBeaker1ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel2Temperature1.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature1Delivery2Label.setText(ledBeaker2ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel2Temperature2.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature2Delivery2Label.setText(ledBeaker2ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel3Temperature1.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature1Delivery3Label.setText(ledBeaker3ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel3Temperature2.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature2Delivery3Label.setText(ledBeaker3ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel4Temperature1.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature1Delivery4Label.setText(ledBeaker4ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel4Temperature2.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature2Delivery4Label.setText(ledBeaker4ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel5Temperature1.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature1BackFlow1Label.setText(ledBeaker1ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel5Temperature2.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature2BackFlow1Label.setText(ledBeaker1ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel6Temperature1.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature1BackFlow2Label.setText(ledBeaker2ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel6Temperature2.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature2BackFlow2Label.setText(ledBeaker2ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel7Temperature1.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature1BackFlow3Label.setText(ledBeaker3ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel7Temperature2.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature2BackFlow3Label.setText(ledBeaker3ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel8Temperature1.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature1BackFlow4Label.setText(ledBeaker4ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
        ...
        if ((value = ModbusMapFlow.Channel8Temperature2.getLastValue().toString()) != null) {
            convertedValue.append(firmwareDataConverter.
                    roundToOneDecimalPlace(firmwareDataConverter.convertDataToFloat(value))).append(DEGREES_CELSIUS);
            temperature2BackFlow4Label.setText(ledBeaker4ToggleButton.isSelected() ? value : null);
            convertedValue.setLength(0);
        }
