...
public class ConnectCallable implements Callable<Boolean> {
    ...
    private Logger logger = LoggerFactory.getLogger(ConnectCallable.class);
    ...
    public ConnectCallable(Devices devices, String addressLine, int port,
                           StatusBarWrapper statusBar, Device dieselDevice, SchedulerNotifier schedularNotifier, InetAddressWrapper inetAddressWrapper) {
