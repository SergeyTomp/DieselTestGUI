...
public class SiemensCoderTwo extends SiemensCoder {

    public SiemensCoderTwo(List<Integer> activeLEDs, List<Result> oldCodes) {
        super(activeLEDs, oldCodes);
        super.TEST_COEFF.put(MAX_LOAD, 1);
        super.TEST_COEFF.put(PRE_INJ, 2);
        super.TEST_COEFF.put(PART_LOAD, 3);
        super.TEST_COEFF.put(IDLE, 4);
