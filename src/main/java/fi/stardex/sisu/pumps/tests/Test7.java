...
public class Test7 extends RescalincgPumpTest {
//
...
//        lines.add(String.format("Set shut off valve current: %.1f A", currentPumpObtainer.getPump().getShutOffValveDefCur()));
